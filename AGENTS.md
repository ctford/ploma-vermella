...
.venv/bin/pv build-epub <doc-url> ... [-o OUT] [--title T] [--subtitle S] [--author A] [--cover IMG] [--max-image-width N] [--no-optimize] [--part "TITLE=START_DOC_URL" ...]
                                                       ...
                                                       # --part groups chapters under a Part in the Contents/nav AND emits a separator
                                                       # page before the Part's first chapter, linked from the Part heading.
                                                       # An EMPTY title ends the run: --part "=<doc>" returns to no-part, which is
                                                       # what keeps back matter out of the last Part.
